...
export class Migration1659072580703 implements MigrationInterface {
    name = 'Migration1659072580703'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE \`category_scheme_entity\` (\`categorySchemeId\` varchar(36) NOT NULL, \`taxonomyId\` varchar(255) NOT NULL, \`id\` int NOT NULL, \`name\` varchar(64) NOT NULL, \`slug\` varchar(32) NOT NULL, \`order\` int NOT NULL, \`parentId\` int NULL, INDEX \`IDX_0a7aadfe205fef90204f382063\` (\`taxonomyId\`), PRIMARY KEY (\`categorySchemeId\`)) ENGINE=InnoDB`);
