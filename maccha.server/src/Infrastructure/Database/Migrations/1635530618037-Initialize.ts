...
export class Initialize1635530618037 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE \`web_site_entity\` (\`webSiteId\` char(36) NOT NULL, \`name\` varchar(128) NOT NULL, \`displayName\` varchar(128) NOT NULL, \`host\` varchar(256) NOT NULL, \`description\` varchar(1024) NOT NULL, \`updatedAt\` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6) ON UPDATE CURRENT_TIMESTAMP(6), \`createdAt\` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6), UNIQUE INDEX \`IDX_7f6dc0460138bc643cf9427c61\` (\`name\`), PRIMARY KEY (\`webSiteId\`)) ENGINE=InnoDB`);
        await queryRunner.query(`CREATE TABLE \`user_web_site_entity\` (\`userWebSiteId\` int NOT NULL AUTO_INCREMENT, \`userId\` varchar(255) NOT NULL, \`webSiteId\` char(36) NOT NULL, INDEX \`IDX_38341366302d85a21ecff6c2c5\` (\`userId\`), PRIMARY KEY (\`userWebSiteId\`)) ENGINE=InnoDB`);
        await queryRunner.query(`CREATE TABLE \`taxonomy_entity\` (\`taxonomyId\` char(36) NOT NULL, \`name\` varchar(255) NOT NULL, \`description\` varchar(255) NOT NULL, \`displayName\` varchar(255) NOT NULL, \`isDeleted\` tinyint NOT NULL, \`identifier\` varchar(255) NOT NULL, INDEX \`IDX_71e9888eb6274400644240b4f8\` (\`identifier\`), PRIMARY KEY (\`taxonomyId\`)) ENGINE=InnoDB`);
        await queryRunner.query(`CREATE TABLE \`post_type_entity\` (\`postTypeId\` char(36) NOT NULL, \`taxonomyId\` char(128) NOT NULL, \`displayFormat\` varchar(255) NOT NULL, \`identifier\` varchar(255) NOT NULL, \`isDeleted\` tinyint NOT NULL, INDEX \`IDX_7c0a0c1c20c138016f362240f9\` (\`identifier\`), UNIQUE INDEX \`REL_4ad0a6c725ceace2c07c9df8ef\` (\`taxonomyId\`), PRIMARY KEY (\`postTypeId\`)) ENGINE=InnoDB`);
        await queryRunner.query(`CREATE TABLE \`scheme_entity\` (\`schemeId\` char(36) NOT NULL, \`taxonomyId\` char(36) NOT NULL, \`type\` varchar(64) NOT NULL, \`name\` varchar(64) NOT NULL, \`displayName\` varchar(64) NOT NULL, \`description\` varchar(512) NOT NULL, \`metadata\` varchar(2048) NOT NULL, \`sort\` int NOT NULL, PRIMARY KEY (\`schemeId\`)) ENGINE=InnoDB`);
        await queryRunner.query(`CREATE TABLE \`content_entity\` (\`contentId\` char(36) NOT NULL, \`identifier\` varchar(255) NOT NULL, \`description\` varchar(255) NOT NULL, \`taxonomyId\` varchar(255) NOT NULL, \`title\` varchar(255) NOT NULL, \`thumbnail\` varchar(255) NOT NULL, \`status\` int NOT NULL, \`metadata\` text NOT NULL, \`updatedAt\` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6) ON UPDATE CURRENT_TIMESTAMP(6), \`createdAt\` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6), \`publishIn\` datetime NULL, \`createdBy\` varchar(255) NOT NULL, INDEX \`IDX_bd9d611a55197686ce0801062b\` (\`identifier\`), PRIMARY KEY (\`contentId\`)) ENGINE=InnoDB`);
